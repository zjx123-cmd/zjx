...
!function (a, b) {
    a.fn.noUiSlider = function (c) {
        ...
        function g(a, c) {
            c && a.preventDefault();
            var d, e, f = a, g = 0 === a.type.indexOf("touch"), h = 0 === a.type.indexOf("mouse"), i = 0 === a.type.indexOf("MSPointer");
            return a = a.originalEvent, g && (d = a.changedTouches[0].pageX, e = a.changedTouches[0].pageY), h && (window.pageXOffset === b && (window.pageXOffset = document.documentElement.scrollLeft, window.pageYOffset = document.documentElement.scrollTop), d = a.clientX + window.pageXOffset, e = a.clientY + window.pageYOffset), i && (d = a.pageX, e = a.pageY), {pass: f.data, e: a, x: d, y: e, t: [g, h, i]}
        }
        ...
        function i(b, c) {
            ...
            }}, slide: {t: function (a, b) {
                return"function" == typeof b
            }}, step: {t: function (a, b, c) {
        ...
        function k(a, b, c) {
            var d, e = a.data("nui").options, f = a.data("nui").base.data(x[12]), g = a.data("nui").style, h = a.data("nui").decimals;
        ...
        function l(c, e) {
            ...
            }) : "string" == typeof e.to[f] ? a('<input type="hidden" class="' + x[3] + '" name="' + e.to[f] + '">').appendTo(c).change(d) : e.to[f] === !1 ? {val: function (a) {
                return a === b ? this.handleElement.data("nui-val") : void this.handleElement.data("nui-val", a)
            }, hasClass: function () {
                return!1
            }, handleElement: c} : void 0
        }

        function m(a) {
            if (a = g(a, !0)) {
                var b = a.pass.base, c = b.data("style"), d = a.x - a.pass.startEvent.x, f = "left" === c ? b.width() : b.height();
        ...
        function o(b) {
            if (!f(b) && (b = g(b))) {
                var c = b.pass.handle, d = c[0].getPercentage(c.data("nui").style);
                c.children().addClass("noUi-active"), u.on(v.move, {startEvent: b, position: d, base: b.pass.base, handle: c}, m), u.on(v.end, {base: b.pass.base, handle: c}, n), a("body").on("selectstart" + t, function () {
                    return!1
                })
            }
        }
        ...
        function p(a) {
            n({data: {base: a.data.base, handle: a.data.handle}}), a.stopPropagation()
        }

        function q(a) {
            if (!f(a) && !a.data.base.find("." + x[4]).length && (a = g(a))) {
                var b, c, d, h = a.pass.base, i = a.pass.handles, j = h.data("style"), l = a["left" === j ? "x" : "y"], m = "left" === j ? h.width() : h.height(), n = {x: a.t[2] ? window.pageXOffset : 0}, o = {handles: [], base: {left: h.offset().left - n.x, top: h.offset().top}};
                for (b = 0; b < i.length; b++)o.handles.push({left: i[b].offset().left - n.x, top: i[b].offset().top});
        ...
        function s(c, d) {
            if (c !== b)return a.isArray(c) || (c = [c]), this.each(function () {
                a.each(a(this).data(x[12]), function (a, b) {
                    if (null !== c[a]) {
                        var e, f, g = b.data("nui").options.range, h = z.to(g, parseFloat(c[a])), i = k(b, h, d === !0 ? !1 : !0);
        ...
        var t = ".nui", u = a(document), v = {start: "mousedown" + t + " touchstart" + t, move: "mousemove" + t + " touchmove" + t, end: "mouseup" + t + " touchend" + t}, w = a.fn.val, x = ["noUi-base", "noUi-origin", "noUi-handle", "noUi-input", "noUi-active", "noUi-state-tap", "noUi-target", "-lower", "-upper", "noUi-connect", "noUi-vertical", "noUi-horizontal", "handles", "noUi-background", "noUi-z-index"], y = {base: [x[0], x[13]], origin: [x[1]], handle: [x[2]]}, z = {to: function (a, b) {
        ...
        return window.navigator.msPointerEnabled && (v = {start: "MSPointerDown" + t, move: "MSPointerMove" + t, end: "MSPointerUp" + t}), a.fn.val = function () {
