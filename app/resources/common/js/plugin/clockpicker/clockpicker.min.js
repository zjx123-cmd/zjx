...
!function () {
    ...
    function d(d, g) {
        function i(a, b) {
            var c = l.offset(), d = /^touch/.test(a.type), f = c.left + r, i = c.top + r, k = (d ? a.originalEvent.touches[0] : a).pageX - f, m = (d ? a.originalEvent.touches[0] : a).pageY - i, p = Math.sqrt(k * k + m * m), q = !1;
            if (!b || !(s - u > p || p > s + u)) {
                a.preventDefault();
                ...
                j && l.append(B.canvas), B.setHand(k, m, !b, !0), h.off(n).on(n, function (a) {
                    a.preventDefault();
                    var b = /^touch/.test(a.type), c = (b ? a.originalEvent.touches[0] : a).pageX - f, d = (b ? a.originalEvent.touches[0] : a).pageY - i;
                    (q || c !== k || d !== m) && (q = !0, B.setHand(c, d, !1, !0))
                }), h.off(o).one(o, function (a) {
                    a.preventDefault();
                    var c = /^touch/.test(a.type), d = (c ? a.originalEvent.changedTouches[0] : a).pageX - f, j = (c ? a.originalEvent.changedTouches[0] : a).pageY - i;
        ...
        var k = f(x), l = k.find(".clockpicker-plate"), p = k.find(".clockpicker-hours"), q = k.find(".clockpicker-minutes"), y = "INPUT" === d.prop("tagName"), z = y ? d : d.find("input"), A = d.find(".input-group-addon"), B = this;
        ...
        for (C = 0; 24 > C; C += 1) {
            ...
            var G = C > 0 && 13 > C, H = G ? t : s;
            D.css({left: r + Math.sin(E) * H - u, top: r - Math.cos(E) * H - u}), G && D.css("font-size", "120%"), D.html(0 === C ? "00" : C), p.append(D), D.on(m, i)
        }
        for (C = 0; 60 > C; C += 5)D = F.clone(), E = C / 30 * Math.PI, D.css({left: r + Math.sin(E) * s - u, top: r - Math.cos(E) * s - u}), D.css("font-size", "120%"), D.html(b(C)), q.append(D), D.on(m, i);
        if (l.on(m, function (a) {
            0 === f(a.target).closest(".clockpicker-tick").length && i(a, !0)
        }), j) {
            var I = k.find(".clockpicker-canvas"), J = a("svg");
    ...
    var e, f = window.jQuery, g = f(window), h = f(document), i = "http://www.w3.org/2000/svg", j = "SVGAngle"in window && function () {
    ...
    }(), l = "ontouchstart"in window, m = "mousedown" + (l ? " touchstart" : ""), n = "mousemove.clockpicker" + (l ? " touchmove.clockpicker" : ""), o = "mouseup.clockpicker" + (l ? " touchend.clockpicker" : ""), p = navigator.vibrate ? "vibrate" : navigator.webkitVibrate ? "webkitVibrate" : null, q = 0, r = 100, s = 80, t = 54, u = 13, v = 2 * r, w = k ? 350 : 1, x = ['<div class="popover clockpicker-popover">', '<div class="arrow"></div>', '<div class="popover-title">', '<span class="clockpicker-span-hours text-primary"></span>', " : ", '<span class="clockpicker-span-minutes"></span>', "</div>", '<div class="popover-content">', '<div class="clockpicker-plate">', '<div class="clockpicker-canvas"></div>', '<div class="clockpicker-dial clockpicker-hours"></div>', '<div class="clockpicker-dial clockpicker-minutes clockpicker-dial-out"></div>', "</div>", "</div>", "</div>"].join("");
    d.DEFAULTS = {"default": "", fromnow: 0, placement: "bottom", align: "left", donetext: "完成", autoclose: !1, vibrate: !0}, d.prototype.toggle = function () {
        ...
        var c = "hours" === a, d = c ? this.hoursView : this.minutesView, e = c ? this.minutesView : this.hoursView;
        ...
        var b = this.currentView, c = this[b], d = "hours" === b, e = Math.PI / (d ? 6 : 30), f = c * e, g = d && c > 0 && 13 > c ? t : s, h = Math.sin(f) * g, i = -Math.cos(f) * g, k = this;
        ...
        var g, h = Math.atan2(a, -c), i = "hours" === this.currentView, k = Math.PI / (i || d ? 6 : 30), l = Math.sqrt(a * a + c * c), m = (this.options, i && (s + t) / 2 > l), n = m ? t : s;
        ...
        var o = Math.sin(h) * n, q = -Math.cos(h) * n;
        ...
        return this.each(function () {
            var c = f(this), e = c.data("clockpicker");
