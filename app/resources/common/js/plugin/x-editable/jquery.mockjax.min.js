...
(function (e) {
    ...
    function c(n, r, i) {
        ...
        n.proxy ? t({global: !1, url: n.proxy, type: n.proxyType, data: n.data, dataType: r.dataType === "script" ? "text/plain" : r.dataType, complete: function (e) {
    ...
    function h(t, n, r, i) {
        ...
        return{status: t.status, statusText: t.statusText, readyState: 1, open: function () {
        }, send: function () {
            i.fired = !0;
            c.call(this, t, n, r)
        }, abort: function () {
    ...
    function b(i, s) {
        ...
        for (var f = 0; f < n.length; f++) {
            ...
            w(a, s);
            (function (n, r, i, s) {
                o = t.call(e, e.extend(!0, {}, i, {xhr: function () {
                    return h(n, r, i, s)
                }}))
            })(a, u, s, n[f]);
            return o
    ...
    e.extend({ajax: b});
    e.mockjaxSettings = {log: function (t, n) {
    ...
    }, logging: !0, status: 200, statusText: "OK", responseTime: 500, isTimeout: !1, throwUnmocked: !1, contentType: "text/plain", response: "", responseText: "", responseXML: "", proxy: "", proxyType: "GET", lastModified: null, etag: "", headers: {etag: "IJF@H#@923uf8023hFO@I#H#", "content-type": "text/plain"}};
