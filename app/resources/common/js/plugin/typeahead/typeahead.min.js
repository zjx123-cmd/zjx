...
!function (a) {
    var b = "0.9.3", c = {isMsie: function () {
        ...
        return c.mixin(b.prototype, d, {_handleMouseenter: function () {
            ...
            var b, c, d, f;
            if (this.isVisible()) {
                if (b = this._getSuggestions(), c = b.filter(".tt-is-under-cursor"), c.removeClass("tt-is-under-cursor"), d = b.index(c) + a, d = (d + 1) % (b.length + 1) - 1, -1 === d)return void this.trigger("cursorRemoved");
