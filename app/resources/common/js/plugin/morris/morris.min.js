...
(function () {
    ...
    b = window.Morris = {}, a = jQuery, b.EventEmitter = function () {
        ...
        return c.defaults = {"class": "morris-hover morris-default-style"}, c.prototype.update = function (a, b, c) {
            ...
            var c, d, e, f, g, h;
            return g = this.options.parent.innerWidth(), f = this.options.parent.innerHeight(), d = this.el.outerWidth(), c = this.el.outerHeight(), e = Math.min(Math.max(0, a - d / 2), g - d), null != b ? (h = b - c - 10, 0 > h && (h = b + 10, h + c > f && (h = f / 2 - c / 2))) : h = f / 2 - c / 2, this.el.css({left: e + "px", top: h + "px"})
        ...
        return g(c, a), c.prototype.init = function () {
            return this.pointGrow = Raphael.animation({r: this.options.pointSize + 3}, 25, "linear"), this.pointShrink = Raphael.animation({r: this.options.pointSize}, 25, "linear"), "always" !== this.options.hideHover ? (this.hover = new b.Hover({parent: this.el}), this.on("hovermove", this.onHoverMove), this.on("hoverout", this.onHoverOut)) : void 0
        }, c.prototype.defaults = {lineWidth: 3, pointSize: 4, lineColors: ["#57889c", "#71843f", "#92a2a8", "#afd8f8", "#edc240", "#cb4b4b", "#9440ed"], pointWidths: [1], pointStrokeColors: ["#ffffff"], pointFillColors: [], smooth: !0, xLabels: "auto", xLabelFormat: null, xLabelMargin: 50, continuousLine: !0, hideHover: !1}, c.prototype.calc = function () {
            ...
            var b, c, d, e, f, g, h;
            if (d = this.data[a], "function" == typeof this.options.hoverCallback)b = this.options.hoverCallback(a, this.options); else for (b = "<div class='morris-hover-row-label'>" + d.label + "</div>", h = d.y, c = f = 0, g = h.length; g > f; c = ++f)e = h[c], b += "<div class='morris-hover-point' style='color: " + this.colorFor(d, c, "label") + "'>\n  " + this.options.labels[c] + ":\n  " + this.yLabelFormat(e) + "\n</div>";
            ...
            return this.paths = function () {
                ...
                for (k = [], d = g = 0, h = this.options.ykeys.length; h >= 0 ? h > g : g > h; d = h >= 0 ? ++g : --g)f = this.options.smooth === !0 || (j = this.options.ykeys[d], i.call(this.options.smooth, j) >= 0), c = function () {
                    var a, b, c, f;
                    for (c = this.data, f = [], a = 0, b = c.length; b > a; a++)e = c[a], void 0 !== e._y[d] && f.push({x: e._x, y: e._y[d]});
                    return f
    ...
    }}, hour: c(60), "30min": c(30), "15min": c(15), "10min": c(10), "5min": c(5), minute: c(1), "30sec": d(30), "15sec": d(15), "10sec": d(10), "5sec": d(5), second: d(1)}, b.AUTO_LABEL_ORDER = ["decade", "year", "month", "day", "hour", "30min", "15min", "10min", "5min", "minute", "30sec", "15sec", "10sec", "5sec", "second"], b.Area = function (a) {
        function c(a) {
        ...
        function d(c) {
            return this.onHoverOut = h(this.onHoverOut, this), this.onHoverMove = h(this.onHoverMove, this), this instanceof b.Bar ? void d.__super__.constructor.call(this, a.extend({}, c, {parseTime: !1})) : new b.Bar(c)
        }

        return g(d, c), d.prototype.init = function () {
            return this.cumulative = this.options.stacked, "always" !== this.options.hideHover ? (this.hover = new b.Hover({parent: this.el}), this.on("hovermove", this.onHoverMove), this.on("hoverout", this.onHoverOut)) : void 0
        }, d.prototype.defaults = {barSizeRatio: .75, barGap: 3, barColors: ["#57889c", "#71843f", "#92a2a8", "#afd8f8", "#edc240", "#cb4b4b", "#9440ed"], xLabelMargin: 50}, d.prototype.calc = function () {
            var a;
            ...
            var b, c, d, e, f, g, h, i;
            if ("function" == typeof this.options.hoverCallback)b = this.options.hoverCallback(a, this.options); else for (d = this.data[a], b = "<div class='morris-hover-row-label'>" + d.label + "</div>", i = d.y, c = g = 0, h = i.length; h > g; c = ++g)f = i[c], b += "<div class='morris-hover-point' style='color: " + this.colorFor(d, c, "label") + "'>\n  " + this.options.labels[c] + ":\n  " + this.yLabelFormat(f) + "\n</div>";
        ...
        return c.prototype.defaults = {colors: ["#57889c", "#3980B5", "#679DC6", "#95BBD7", "#B0CCE1", "#095791", "#095085", "#083E67", "#052C48", "#042135"], backgroundColor: "#FFFFFF", labelColor: "#000000", formatter: b.commas}, c.prototype.redraw = function () {
        ...
        return g(b, a), b.prototype.calcArcPoints = function (a) {
            ...
            return this.raphael.path(a).attr({fill: b, stroke: c, "stroke-width": 3}).hover(d)
