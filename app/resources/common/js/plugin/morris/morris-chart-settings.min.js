...
$(document).ready(function () {
    function a(a) {
        for (var b = [], c = 0; 360 >= c; c += 10) {
            var d = (a + c) % 360;
            b.push({x: c, y: Math.sin(Math.PI * d / 180).toFixed(4), z: Math.cos(Math.PI * d / 180).toFixed(4)})
        }
        return b
    }
    ...
    if ($("#sales-graph").length && Morris.Area({element: "sales-graph", data: [
    ...
    ], xkey: "period", ykeys: ["iphone", "ipad", "itouch"], labels: ["iPhone", "iPad", "iPod Touch"], pointSize: 2, hideHover: "auto"}), $("#area-graph").length && Morris.Area({element: "area-graph", data: [
        {x: "2011 Q1", y: 3, z: 3},
        {x: "2011 Q2", y: 2, z: 0},
        {x: "2011 Q3", y: 0, z: 2},
        {x: "2011 Q4", y: 4, z: 4}
    ], xkey: "x", ykeys: ["y", "z"], labels: ["Y", "Z"]}), $("#bar-graph").length && Morris.Bar({element: "bar-graph", data: [
        {x: "2011 Q1", y: 0},
        {x: "2011 Q2", y: 1},
        {x: "2011 Q3", y: 2},
        {x: "2011 Q4", y: 3},
        ...
        return"#000"
    }}), $("#normal-bar-graph").length && Morris.Bar({element: "normal-bar-graph", data: [
        {x: "2011 Q1", y: 3, z: 2, a: 3},
        {x: "2011 Q2", y: 2, z: null, a: 1},
        {x: "2011 Q3", y: 0, z: 2, a: 4},
        {x: "2011 Q4", y: 2, z: 4, a: 3}
    ], xkey: "x", ykeys: ["y", "z", "a"], labels: ["Y", "Z", "A"]}), $("#noline-bar-graph").length && Morris.Bar({element: "noline-bar-graph", axes: !1, data: [
        {x: "2011 Q1", y: 3, z: 2, a: 3},
        {x: "2011 Q2", y: 2, z: null, a: 1},
        {x: "2011 Q3", y: 0, z: 2, a: 4},
        {x: "2011 Q4", y: 2, z: 4, a: 3}
    ], xkey: "x", ykeys: ["y", "z", "a"], labels: ["Y", "Z", "A"]}), $("#year-graph").length) {
        var c = [
        ...
        Morris.Line({element: "year-graph", data: c, xkey: "period", ykeys: ["licensed", "sorned"], labels: ["Licensed", "SORN"]})
    }
    if ($("#decimal-graph").length) {
        for (var d = [], e = 0; 360 >= e; e += 10)d.push({x: e, y: Math.sin(Math.PI * e / 180).toFixed(4)});
        window.m = Morris.Line({element: "decimal-graph", data: d, xkey: "x", ykeys: ["y"], labels: ["sin(x)"], parseTime: !1, hoverCallback: function (a, b) {
            var c = b.data[a];
            return"sin(" + c.x + ") = " + c.y
        }, xLabelMargin: 10})
    }
    if ($("#donut-graph").length && Morris.Donut({element: "donut-graph", data: [
        {value: 70, label: "foo"},
        {value: 15, label: "bar"},
        {value: 10, label: "baz"},
        ...
        Morris.Line({element: "time-graph", data: f, xkey: "period", ykeys: ["licensed", "sorned"], labels: ["Licensed", "SORN"], events: ["2011-04", "2011-08"]})
    }
    if ($("#graph-B").length) {
        var g = [
        ...
        Morris.Line({element: "graph-B", data: g, xkey: "period", ykeys: ["a"], labels: ["Series A"], units: "%"})
    }
    if ($("#nogrid-graph").length) {
        ...
        Morris.Line({element: "nogrid-graph", grid: !1, data: c, xkey: "period", ykeys: ["licensed", "sorned"], labels: ["Licensed", "SORN"]})
    }
    if ($("#non-continu-graph").length) {
        ...
        Morris.Line({element: "non-continu-graph", data: c, xkey: "period", ykeys: ["licensed", "sorned", "other"], labels: ["Licensed", "SORN", "Other"], xLabelFormat: function (a) {
    ...
    if ($("#non-date-graph").length) {
        ...
        Morris.Line({element: "non-date-graph", data: c, xkey: "elapsed", ykeys: ["value"], labels: ["value"], parseTime: !1})
    }
    if ($("#stacked-bar-graph").length && Morris.Bar({element: "stacked-bar-graph", axes: !1, grid: !1, data: [
        {x: "2011 Q1", y: 3, z: 2, a: 3},
        {x: "2011 Q2", y: 2, z: null, a: 1},
        {x: "2011 Q3", y: 0, z: 2, a: 4},
        {x: "2011 Q4", y: 2, z: 4, a: 3}
    ], xkey: "x", ykeys: ["y", "z", "a"], labels: ["Y", "Z", "A"], stacked: !0}), $("#interval-graph").length) {
        var h = 0, i = Morris.Line({element: "interval-graph", data: a(0), xkey: "x", ykeys: ["y", "z"], labels: ["sin()", "cos()"], parseTime: !1, ymin: -1, ymax: 1, hideHover: !0});
        setInterval(b, 100)
    }
});