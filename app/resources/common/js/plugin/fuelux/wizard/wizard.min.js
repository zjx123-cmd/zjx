...
var old = $.fn.wizard, Wizard = function (a, b) {
    var c;
...
Wizard.prototype = {constructor: Wizard, setState: function () {
    var a = this.currentStep > 1, b = 1 === this.currentStep, c = this.currentStep === this.numSteps;
    ...
    if (d && d.last && (this.lastText = d.last, "undefined" != typeof this.lastText)) {
        var e = c !== !0 ? this.nextText : this.lastText, f = this.$nextBtn.children().detach();
    ...
    var h = ".steps li:lt(" + (this.currentStep - 1) + ")", i = this.$element.find(h);
    i.addClass("complete"), i.find("span.badge").addClass("badge-success");
    var j = ".steps li:eq(" + (this.currentStep - 1) + ")", k = this.$element.find(j);
    ...
    var b = $(a.currentTarget), c = this.$element.find(".steps li").index(b), d = !0;
    if (this.options.disablePreviousStep && c < this.currentStep && (d = !1), d) {
        var e = $.Event("stepclick");
        if (this.$element.trigger(e, {step: c + 1}), e.isDefaultPrevented())return;
    ...
    if (this.options.disablePreviousStep && (a = !1), a) {
        var b = $.Event("change");
        if (this.$element.trigger(b, {step: this.currentStep, direction: "previous"}), b.isDefaultPrevented())return;
        this.currentStep -= 1, this.setState()
    }
}, next: function () {
    var a = this.currentStep + 1 <= this.numSteps, b = this.currentStep === this.numSteps;
    if (a) {
        var c = $.Event("change");
        if (this.$element.trigger(c, {step: this.currentStep, direction: "next"}), c.isDefaultPrevented())return;
        this.currentStep += 1, this.setState()
    } else b && this.$element.trigger("finished")
}, selectedItem: function (a) {
    var b, c;
    return a ? (c = a.step || -1, c >= 1 && c <= this.numSteps && (this.currentStep = c, this.setState()), b = this) : b = {step: this.currentStep}, b
}}, $.fn.wizard = function (a) {
    var b, c = Array.prototype.slice.call(arguments, 1), d = this.each(function () {
        var d = $(this), e = d.data("wizard"), f = "object" == typeof a && a;
