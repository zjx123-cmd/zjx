...
!function (a) {
    function b(a) {
        ...
        function d(a) {
            var b = u ? a.getPlaceholder().innerHeight() : a.getPlaceholder().innerWidth(), c = u ? e(a.getData(), 1) : e(a.getData(), 0), d = c[1] - c[0];
            t = d / b
        }
        ...
        function h(a, b) {
            var c = a.bars.order, d = b.bars.order;
        ...
        function k(a) {
            for (var b = 0, c = 0; c < p.length; ++c)if (a == p[c]) {
                b = c;
                break
            }
            return b + 1
    ...
    a.plot.plugins.push({init: b, options: c, name: "orderBars", version: "0.2"})
}(jQuery);