...
function tableToGrid(a, b) {
    jQuery(a).each(function () {
        if (!this.grid) {
            ...
            }), jQuery(this).empty(), jQuery(this).addClass("scroll"), jQuery(this).jqGrid(jQuery.extend({datatype: "local", width: a, colNames: g, colModel: f, multiselect: c}, b || {})), a = 0; a < h.length; a++)d = null, 0 < i.length && (d = i[a]) && d.replace && (d = encodeURIComponent(d).replace(/[.\-%]/g, "_")), null === d && (d = a + 1), jQuery(this).jqGrid("addRowData", d, h[a]);
            for (a = 0; a < j.length; a++)jQuery(this).jqGrid("setSelection", j[a])
        }
    })
}
!function (b) {
    b.jgrid = b.jgrid || {}, b.extend(b.jgrid, {version: "4.5.3", htmlDecode: function (a) {
        ...
        var l = k.getMilliseconds(), m = k.getDay(), n = k.getFullYear(), o = (m + 6) % 7 + 1, p = (new Date(n, i - 1, j) - new Date(n, 0, 1)) / 864e5, q = {d: h(j), D: e.dayNames[m], j: j, l: e.dayNames[m + 7], N: o, S: e.S(j), w: m, z: p, W: 5 > o ? Math.floor((p + o - 1) / 7) + 1 : Math.floor((p + o - 1) / 7) || (4 > (new Date(n - 1, 0, 1).getDay() + 6) % 7 ? 53 : 52), F: e.monthNames[i - 1 + 12], m: h(i), M: e.monthNames[i - 1], n: i, t: "?", L: "?", o: "?", Y: n, y: ("" + n).substring(2), a: 12 > a ? e.AmPm[0] : e.AmPm[1], A: 12 > a ? e.AmPm[2] : e.AmPm[3], B: "?", g: a % 12 || 12, G: a, h: h(a % 12 || 12), H: h(a), i: h(c), s: h(g), u: l, e: "?", I: "?", O: (f > 0 ? "-" : "+") + h(100 * Math.floor(Math.abs(f) / 60) + Math.abs(f) % 60, 4), P: "?", T: (("" + k).match(/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g) || [""]).pop().replace(/[^-+\dA-Z]/g, ""), Z: "?", c: "?", r: "?", U: Math.floor(k / 1e3)};
        ...
        return new function (d, c) {
            ...
            return 0 < d.length && (E = "object" != typeof d[0] ? !1 : !0), this._hasData = function () {
                ...
                void 0 === f && (f = "text"), k = "float" === f || "number" === f || "currency" === f || "numeric" === f ? function (a) {
                    ...
                    h = "" !== c ? b.jgrid.getAccessor(d, c) : d, void 0 === h && (h = ""), h = k(h, d), m.push({vSort: h, index: a})
                }), m.sort(function (a, b) {
                ...
                return c = null == c ? "a" : b.trim(c.toString().toLowerCase()), null == d && (d = "text"), null == f && (f = "Y-m-d"), ("desc" === c || "descending" === c) && (c = "d"), ("asc" === c || "ascending" === c) && (c = "a"), u.push({by: a, dir: c, type: d, datefmt: f}), e
            }, e
        }(d, null)
                ...
                if ("TABLE" !== this.tagName.toUpperCase())alert("Element is not a table"); else if (void 0 !== document.documentMode && 5 >= document.documentMode)alert("Grid can not be used in this ('quirks') mode!"); else {
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length)alert(b.jgrid.errors.model); else {
                        ...
                        var k = function (a, b) {
                            ...
                            return void 0 !== h.formatter ? (a = "" + d.p.idPrefix != "" ? b.jgrid.stripPref(d.p.idPrefix, a) : a, a = {rowId: a, colModel: h, gid: d.p.id, pos: e}, c = b.isFunction(h.formatter) ? h.formatter.call(d, c, a, f, g) : b.fmatter ? b.fn.fmatter.call(d, h.formatter, c, a, f, g) : m(c)) : c = m(c), c
                            ...
                            var d;
                            this.p.deepempty ? b(this.rows).slice(1).remove() : (d = this.rows.length > 0 ? this.rows[0] : null, b(this.firstChild).empty().append(d)), a && this.p.scroll && (b(this.grid.bDiv.firstChild).css({height: "auto"}), b(this.grid.bDiv.firstChild.firstChild).css({height: 0, display: "none"}), 0 !== this.grid.bDiv.scrollTop && (this.grid.bDiv.scrollTop = 0)), c === !0 && this.p.treeGrid && (this.p.data = [], this.p._index = {})
                        }, u = function () {
                            ...
                            if (!d.grid.hDiv.loading) {
                                ...
                                if (f !== !1 && "stop" !== f)if (b.isFunction(d.p.datatype))d.p.datatype.call(d, d.p.postData, "load_" + d.p.id, o, a, j); else {
                                    ...
                                    switch (c = d.p.datatype.toLowerCase()) {
                                        ...
                                        case"xml":
                                        case"script":
                                            b.ajax(b.extend({url: d.p.url, type: d.p.mtype, dataType: c, data: b.isFunction(d.p.serializeGridData) ? d.p.serializeGridData.call(d, d.p.postData) : d.p.postData, success: function (f, g, h) {
                        ...
                        b(d).before(e.hDiv).click(function (a) {
                            ...
                            if ((e = e === !1 || "stop" === e ? !1 : !0) && b.isFunction(d.p.beforeSelectRow) && (e = d.p.beforeSelectRow.call(d, Q[0].id, a)), "A" !== P.tagName && ("INPUT" !== P.tagName && "TEXTAREA" !== P.tagName && "OPTION" !== P.tagName && "SELECT" !== P.tagName || c) && e === !0)if (ab = Q[0].id, bb = b.jgrid.getCellIndex(P), cb = b(P).closest("td,th").html(), b(d).triggerHandler("jqGridCellSelect", [ab, bb, cb, a]), b.isFunction(d.p.onCellSelect) && d.p.onCellSelect.call(d, ab, bb, cb, a), d.p.cellEdit === !0)if (d.p.multiselect && c)b(d).jqGrid("setSelection", ab, !0, a); else {
                                ab = Q[0].rowIndex;
                                try {
                                    b(d).jqGrid("editCell", ab, bb, !0)
                                } catch (f) {
                                }
                            } else if (d.p.multikey)a[d.p.multikey] ? b(d).jqGrid("setSelection", ab, !0, a) : d.p.multiselect && c && (c = b("#jqg_" + b.jgrid.jqID(d.p.id) + "_" + ab).is(":checked"), b("#jqg_" + b.jgrid.jqID(d.p.id) + "_" + ab)[d.p.useProp ? "prop" : "attr"]("checked", c)); else {
                        ...
                        }), e.bDiv = document.createElement("div"), i && "auto" === ("" + d.p.height).toLowerCase() && (d.p.height = "100%"), b(e.bDiv).append(b('<div style="position:relative;' + (i && 8 > b.jgrid.msiever() ? "height:0.01%;" : "") + '"></div>').append("<div></div>").append(this)).addClass("ui-jqgrid-bdiv").css({height: d.p.height + (isNaN(d.p.height) ? "" : "px"), width: e.width + "px"}).scroll(e.scrollGrid), b("table:first", e.bDiv).css({width: d.p.tblwidth + "px"}), b.support.tbody || 2 === b("tbody", this).length && b("tbody:gt(0)", this).remove(), d.p.multikey && (b.jgrid.msie ? b(e.bDiv).bind("selectstart", function () {
                            return!1
                        ...
                        b(e.hDiv).after(e.bDiv).mousemove(function (a) {
                            ...
                            return n(a, b, c, d, e)
                        }, b.extend(e, {populate: B, emptyRows: t, beginReq: z, endReq: A}), this.grid = e, d.addXmlData = function (a) {
                            w(a, d.grid.bDiv)
    ...
    }, b.jgrid.extend({getGridParam: function (a) {
        var b = this[0];
        ...
        return this.each(function () {
            ...
            if (this.grid && (isNaN(c) ? b(this.p.colModel).each(function (a) {
                ...
                if (f)try {
                    d = b.unformat.call(this, b("td:eq(" + e + ")", f), {rowId: f.id, colModel: this.p.colModel[e]}, e)
                } catch (g) {
                ...
                if (l && l > 0) {
                    for (; l > m;) {
                        if (b(this.rows[m]).hasClass("jqgrow")) {
                            try {
                                e = b.unformat.call(this, b(this.rows[m].cells[k]), {rowId: this.rows[m].id, colModel: this.p.colModel[k]}, k)
                            } catch (o) {
                                e = b.jgrid.htmlDecode(this.rows[m].cells[k].innerHTML)
                            }
                            d ? (h = parseFloat(e), isNaN(h) || (j += h, void 0 === g && (g = f = h), f = Math.min(f, h), g = Math.max(g, h), n++)) : i.push(c ? {id: this.rows[m].id, value: e} : e)
                        }
                        m++
                    }
        ...
        var c = b.extend({onEnter: null, onSpace: null, onLeftKey: null, onRightKey: null, scrollingRows: !0}, a || {});
        return this.each(function () {
            var a = this;
    ...
    a.fmatter = {}, a.extend(a.fmatter, {isBoolean: function (a) {
        ...
        switch (void 0 !== h.formatoptions && (j = a.extend(j, h.formatoptions)), void 0 !== g.editOptions && (j.editOptions = g.editOptions), void 0 !== g.delOptions && (j.delOptions = g.delOptions), c.hasClass("jqgrid-new-row") && (j.extraparam[g.prmNames.oper] = g.prmNames.addoper), c = {keys: j.keys, oneditfunc: j.onEdit, successfunc: j.onSuccess, url: j.url, extraparam: j.extraparam, aftersavefunc: function (b, c) {
        ...
        }, errorfunc: j.onError, afterrestorefunc: k, restoreAfterError: j.restoreAfterError, mtype: j.mtype}, b) {
            case"edit":
    ...
    a.jgrid.extend({getColProp: function (a) {
        ...
        return this.each(function () {
            var d, e = -1, f = !1;
            if (this.grid) {
                for (a || (a = this.p.sortname), d = 0; d < this.p.colModel.length; d++)if (this.p.colModel[d].index === a || this.p.colModel[d].name === a) {
        ...
        return b = a.extend({autosearch: !0, searchOnEnter: !0, beforeSearch: null, afterSearch: null, beforeClear: null, afterClear: null, searchurl: "", stringResult: !1, groupOp: "AND", defaultSearch: "bw", searchOperators: !1, operandTitle: "Click to select search operation.", operands: {eq: "==", ne: "!", lt: "<", le: "<=", gt: ">", ge: ">=", bw: "^", bn: "!^", "in": "=", ni: "!=", ew: "|", en: "!@", cn: "~", nc: "!~", nu: "#", nn: "!#"}}, a.jgrid.search, b || {}), this.each(function () {
            var c = this;
            if (!this.ftoolbar) {
                var d, e = function () {
                    var d, e, f, g = {}, h = 0, i = {};
                    ...
                    !n && a.isFunction(b.beforeSearch) && (n = b.beforeSearch.call(c)), n || a(c).jqGrid("setGridParam", {search: j}).trigger("reloadGrid", [
                        {page: 1}
                    ]), m && a(c).jqGrid("setGridParam", {url: m}), a(c).triggerHandler("jqGridToolbarAfterSearch"), a.isFunction(b.afterSearch) && b.afterSearch.call(c)
                }, f = function (d, f, g) {
                    a("#sopt_menu").remove();
                ...
                a.each(c.p.colModel, function (f) {
                    ...
                    if (!0 === this.hidden && a(m).css("display", "none"), this.search = !1 === this.search ? !1 : !0, void 0 === this.stype && (this.stype = "text"), h = a.extend({}, this.searchoptions || {}), this.search) {
                        ...
                        switch (a("td:eq(0)", o).attr("colindex", f).append(i), void 0 === h.clearSearch && (h.clearSearch = !0), h.clearSearch && a("td:eq(2)", o).append("<a title='Clear Search Value' style='padding-right: 0.3em;padding-left: 0.3em;' class='clearsearchclass'>x</a>"), this.stype) {
                            case"select":
                                if (i = this.surl || h.dataUrl)a(n).append(o), a.ajax(a.extend({url: i, dataType: "html", success: function (d) {
                                    void 0 !== h.buildSelect ? (d = h.buildSelect(d)) && a("td:eq(1)", o).append(d) : a("td:eq(1)", o).append(d), void 0 !== h.defaultValue && a("select", n).val(h.defaultValue), a("select", n).attr({name: j.index || j.name, id: "gs_" + j.name}), h.attr && a("select", n).attr(h.attr), a("select", n).css({width: "100%"}), a.jgrid.bindEv.call(c, a("select", n)[0], h), b.autosearch === !0 && a("select", n).change(function () {
                                        return e(), !1
                                    }), d = null
                                    ...
                                    if (j.searchoptions ? (p = void 0 === j.searchoptions.value ? "" : j.searchoptions.value, q = void 0 === j.searchoptions.separator ? ":" : j.searchoptions.separator, r = void 0 === j.searchoptions.delimiter ? ";" : j.searchoptions.delimiter) : j.editoptions && (p = void 0 === j.editoptions.value ? "" : j.editoptions.value, q = void 0 === j.editoptions.separator ? ":" : j.editoptions.separator, r = void 0 === j.editoptions.delimiter ? ";" : j.editoptions.delimiter), p) {
                                        f = document.createElement("select"), f.style.width = "100%", a(f).attr({name: j.index || j.name, id: "gs_" + j.name});
                                        var s;
                    ...
                    !l && a.isFunction(b.beforeClear) && (l = b.beforeClear.call(c)), l || d && a(c).jqGrid("setGridParam", {search: h}).trigger("reloadGrid", [
                        {page: 1}
                    ]), k && a(c).jqGrid("setGridParam", {url: k}), a(c).triggerHandler("jqGridToolbarAfterClear"), a.isFunction(b.afterClear) && b.afterClear()
        ...
        return b = a.extend({useColSpanStyle: !1, groupHeaders: []}, b || {}), this.each(function () {
            ...
            void 0 === p[0] ? p = a("<tr>", {role: "row", "aria-hidden": "true"}).addClass("jqg-first-row-header").css("height", "auto") : p.empty();
            var q, r = function (a, b) {
                var c, d = b.length;
                for (c = 0; d > c; c++)if (b[c].startColumnName === a)return c;
                return-1
            };
            for (a(this).prepend(e), e = a("<tr>", {role: "rowheader"}).addClass("ui-jqgrid-labels jqg-third-row-header"), c = 0; l > c; c++)if (g = m[c].el, h = a(g), d = k[c], f = {height: "0px", width: m[c].width + "px", display: d.hidden ? "none" : ""}, a("<th>", {role: "gridcell"}).css(f).addClass("ui-first-th-" + this.p.direction).appendTo(p), g.style.width = "", f = r(d.name, b.groupHeaders), f >= 0) {
                for (f = b.groupHeaders[f], j = f.numberOfColumns, i = f.titleText, f = d = 0; j > f && l > c + f; f++)k[c + f].hidden || d++;
                f = a("<th>").attr({role: "columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-" + this.p.direction).css({height: "22px", "border-top": "0px none"}).html(i), d > 0 && f.attr("colspan", "" + d), this.p.headertitles && f.attr("title", f.text()), 0 === d && f.hide(), h.before(f), e.append(g), j -= 1
            } else 0 === j ? b.useColSpanStyle ? h.attr("rowspan", "2") : (a("<th>", {role: "columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-" + this.p.direction).css({display: d.hidden ? "none" : "", "border-top": "0px none"}).insertBefore(h), e.append(g)) : (e.append(g), j--);
    ...
    a.extend(a.jgrid, {showModal: function (a) {
        ...
        !0 === d.closeOnEscape && a(j).keydown(function (c) {
            27 == c.which && (c = a("#" + a.jgrid.jqID(b.themodal)).data("onClose") || d.onClose, k.hideModal("#" + a.jgrid.jqID(b.themodal), {gb: d.gbox, jqm: d.jqModal, onClose: c}))
        })
    }, viewModal: function (b, c) {
        if (c = a.extend({toTop: !0, overlay: 10, modal: !1, overlayClass: "ui-widget-overlay", onShow: a.jgrid.showModal, onHide: a.jgrid.closeModal, gbox: "", jqm: !0, jqM: !0}, c || {}), a.fn.jqm && !0 === c.jqm)c.jqM ? a(b).attr("aria-hidden", "false").jqm(c).jqmShow() : a(b).attr("aria-hidden", "false").jqmShow(); else {
        ...
        var f = {width: 290, height: "auto", dataheight: "auto", drag: !0, resize: !1, left: 250, top: 170, zIndex: 1e3, jqModal: !0, modal: !1, closeOnEscape: !0, align: "center", buttonalign: "center", buttons: []};
        ...
        a.jgrid.createModal({themodal: "info_dialog", modalhead: "info_head", modalcontent: "info_content", scrollelm: "infocnt"}, c, f, "", "", !0), b && a.each(f.buttons, function (b) {
        ...
        switch (b) {
            ...
            case"select":
                if (h = document.createElement("select"), h.setAttribute("role", "select"), e = [], !0 === c.multiple ? (b = !0, h.multiple = "multiple", a(h).attr("aria-multiselectable", "true")) : b = !1, void 0 !== c.dataUrl) {
                    ...
                    i.p && i.p.idPrefix && (b = a.jgrid.stripPref(i.p.idPrefix, b)), a.ajax(a.extend({url: a.isFunction(c.dataUrl) ? c.dataUrl.call(i, b, d, "" + c.name) : c.dataUrl, type: "GET", dataType: "html", data: a.isFunction(j) ? j.call(i, b, d, "" + c.name) : j, context: {elem: h, options: c, vl: d}, success: function (b) {
    ...
    a.jgrid.extend({searchGrid: function (b) {
        return b = a.extend(!0, {recreateFilter: !1, drag: !0, sField: "searchField", sValue: "searchString", sOper: "searchOper", sFilter: "filters", loadDefaults: !0, beforeShowSearch: null, afterShowSearch: null, onInitializeSearch: null, afterRedraw: null, afterChange: null, closeAfterSearch: !1, closeAfterReset: !1, closeOnEscape: !1, searchOnEnter: !1, multipleSearch: !1, multipleGroup: !1, top: 0, left: 0, jqModal: !0, modal: !1, resize: !0, width: 450, height: "auto", dataheight: "auto", showQuery: !1, errorcheck: !0, sopt: null, stringResult: void 0, onClose: null, onSearch: null, onReset: null, toTop: !0, overlay: 30, columns: [], tmplNames: null, tmplFilters: null, tmplLabel: " Template: ", showOnLoad: !1, layer: null, operands: {eq: "=", ne: "<>", lt: "<", le: "<=", gt: ">", ge: ">=", bw: "LIKE", bn: "NOT LIKE", "in": "IN", ni: "NOT IN", ew: "LIKE", en: "NOT LIKE", cn: "LIKE", nc: "NOT LIKE", nu: "IS NULL", nn: "ISNOT NULL"}}, a.jgrid.search, b || {}), this.each(function () {
            function c(c) {
                f = a(d).triggerHandler("jqGridFilterBeforeShow", [c]), void 0 === f && (f = !0), f && a.isFunction(b.beforeShowSearch) && (f = b.beforeShowSearch.call(d, c)), f && (a.jgrid.viewModal("#" + a.jgrid.jqID(h.themodal), {gbox: "#gbox_" + a.jgrid.jqID(e), jqm: b.jqModal, modal: b.modal, overlay: b.overlay, toTop: b.toTop}), a(d).triggerHandler("jqGridFilterAfterShow", [c]), a.isFunction(b.afterShowSearch) && b.afterShowSearch.call(d, c))
            }

            var d = this;
            if (d.grid) {
                var e = "fbox_" + d.p.id, f = !0, g = !0, h = {themodal: "searchmod" + e, modalhead: "searchhd" + e, modalcontent: "searchcnt" + e, scrollelm: e}, i = d.p.postData[b.sFilter];
                if ("string" == typeof i && (i = a.jgrid.parse(i)), !0 === b.recreateFilter && a("#" + a.jgrid.jqID(h.themodal)).remove(), void 0 !== a("#" + a.jgrid.jqID(h.themodal))[0])c(a("#fbox_" + a.jgrid.jqID(+d.p.id))); else {
                    ...
                    if (b.showQuery && (q = "<a id='" + e + "_query' class='fm-button ui-state-default ui-corner-all fm-button-icon-left'><span class='ui-icon ui-icon-comment'></span>Query</a>"), b.columns.length ? (n = b.columns, t = 0, m = n[0].index || n[0].name) : a.each(n, function (a, b) {
                        ...
                        var u = "eq";
                        t >= 0 && n[t].searchoptions && n[t].searchoptions.sopt ? u = n[t].searchoptions.sopt[0] : b.sopt && b.sopt.length && (u = b.sopt[0]), i = {groupOp: "AND", rules: [
                            {field: m, op: u, data: ""}
                        ]}
                    }
                    s = !1, b.tmplNames && b.tmplNames.length && (s = !0, r = b.tmplLabel, r += "<select class='ui-template'>", r += "<option value='default'>Default</option>", a.each(b.tmplNames, function (a, b) {
                    ...
                    }), r += "</select>"), k = "<table class='EditTable' style='border:0px none;margin-top:5px' id='" + e + "_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='EditButton' style='text-align:" + k + "'>" + p + r + "</td><td class='EditButton' " + l + ">" + q + o + "</td></tr></tbody></table>", e = a.jgrid.jqID(e), a("#" + e).jqFilter({columns: n, filter: b.loadDefaults ? i : null, showQuery: b.showQuery, errorcheck: b.errorcheck, sopt: b.sopt, groupButton: b.multipleGroup, ruleButtons: b.multipleSearch, afterRedraw: b.afterRedraw, ops: b.odata, operands: b.operands, ajaxSelectOptions: d.p.ajaxSelectOptions, groupOps: b.groupOps, onChange: function () {
                        this.p.showQuery && a(".query", this).html(this.toUserFriendlyString()), a.isFunction(b.afterChange) && b.afterChange.call(d, a("#" + e), b)
                    }, direction: d.p.direction, id: d.p.id}), j.append(k), s && b.tmplFilters && b.tmplFilters.length && a(".ui-template", j).bind("change", function () {
                        var c = a(this).val();
                        ...
                        return d.p.search = !0, a.extend(d.p.postData, i), g = a(d).triggerHandler("jqGridFilterSearch"), void 0 === g && (g = !0), g && a.isFunction(b.onSearch) && (g = b.onSearch.call(d, d.p.filters)), g !== !1 && a(d).trigger("reloadGrid", [
                            {page: 1}
                        ]), b.closeAfterSearch && a.jgrid.hideModal("#" + a.jgrid.jqID(h.themodal), {gb: "#gbox_" + a.jgrid.jqID(d.p.id), jqm: b.jqModal, onClose: b.onClose}), !1
                        ...
                        return d.p.search = !1, b.multipleSearch === !1 ? c[b.sField] = c[b.sValue] = c[b.sOper] = "" : c[b.sFilter] = "", f[0].resetFilter(), s && a(".ui-template", j).val("default"), a.extend(d.p.postData, c), g = a(d).triggerHandler("jqGridFilterReset"), void 0 === g && (g = !0), g && a.isFunction(b.onReset) && (g = b.onReset.call(d)), g !== !1 && a(d).trigger("reloadGrid", [
                            {page: 1}
                        ]), b.closeAfterReset && a.jgrid.hideModal("#" + a.jgrid.jqID(h.themodal), {gb: "#gbox_" + a.jgrid.jqID(d.p.id), jqm: b.jqModal, onClose: b.onClose}), !1
        ...
        return d = a.extend(!0, {top: 0, left: 0, width: 300, datawidth: "auto", height: "auto", dataheight: "auto", modal: !1, overlay: 30, drag: !0, resize: !0, url: null, mtype: "POST", clearAfterAdd: !0, closeAfterEdit: !1, reloadAfterSubmit: !0, onInitializeForm: null, beforeInitData: null, beforeShowForm: null, afterShowForm: null, beforeSubmit: null, afterSubmit: null, onclickSubmit: null, afterComplete: null, onclickPgButtons: null, afterclickPgButtons: null, editData: {}, recreateForm: !1, jqModal: !0, closeOnEscape: !1, addedrow: "first", topinfo: "", bottominfo: "", saveicon: [], closeicon: [], savekey: [!1, 13], navkeys: [!1, 38, 40], checkOnSubmit: !1, checkOnUpdate: !1, _savedData: {}, processing: !1, onClose: null, ajaxEditOptions: {}, serializeEditData: null, viewPagerButtons: !0, overlayClass: "ui-widget-overlay"}, a.jgrid.edit, d || {}), b[a(this)[0].p.id] = d, this.each(function () {
                ...
                return"_empty" !== c && (q = a(d).jqGrid("getInd", c)), a(d.p.colModel).each(function (m) {
                    if (g = this.name, k = (h = this.editrules && !0 === this.editrules.edithidden ? !1 : !0 === this.hidden ? !0 : !1) ? "style='display:none'" : "", "cb" !== g && "subgrid" !== g && !0 === this.editable && "rn" !== g) {
                        if (!1 === q)j = ""; else if (g === d.p.ExpandColumn && !0 === d.p.treeGrid)j = a("td[role='gridcell']:eq(" + m + ")", d.rows[q]).text(); else {
                            try {
                                j = a.unformat.call(d, a("td[role='gridcell']:eq(" + m + ")", d.rows[q]), {rowId: c, colModel: this}, m)
                            } catch (s) {
                        ...
                        var u = a.extend({}, this.editoptions || {}, {id: g, name: g}), v = a.extend({}, {elmprefix: "", elmsuffix: "", rowabove: !1, rowcontent: ""}, this.formoptions || {}), w = parseInt(v.rowpos, 10) || n + 1, x = parseInt(2 * (parseInt(v.colpos, 10) || 1), 10);
            ...
            function i() {
                ...
                if (h(), l[0] && (m = a(o).triggerHandler("jqGridAddEditClickSubmit", [b[o.p.id], p, r]), void 0 === m && a.isFunction(b[o.p.id].onclickSubmit) && (m = b[o.p.id].onclickSubmit.call(o, b[o.p.id], p, r) || {}), l = a(o).triggerHandler("jqGridAddEditBeforeSubmit", [p, a("#" + t), r]), void 0 === l && (l = [!0, "", ""]), l[0] && a.isFunction(b[o.p.id].beforeSubmit) && (l = b[o.p.id].beforeSubmit.call(o, p, a("#" + t), r))), l[0] && !b[o.p.id].processing) {
                    ...
                    p[e] = a.jgrid.stripPref(o.p.idPrefix, p[e]), k = a.extend({url: b[o.p.id].url || a(o).jqGrid("getGridParam", "editurl"), type: b[o.p.id].mtype, data: a.isFunction(b[o.p.id].serializeEditData) ? b[o.p.id].serializeEditData.call(o, p) : p, complete: function (h, i) {
                        var k;
                        ...
                        }), p[f] === n.addoper ? (l[2] || (l[2] = a.jgrid.randId()), p[e] = l[2], b[o.p.id].reloadAfterSubmit ? a(o).trigger("reloadGrid") : o.p.treeGrid === !0 ? a(o).jqGrid("addChildNode", l[2], j, p) : a(o).jqGrid("addRowData", l[2], p, d.addedrow), b[o.p.id].closeAfterAdd ? (o.p.treeGrid !== !0 && a(o).jqGrid("setSelection", l[2]), a.jgrid.hideModal("#" + a.jgrid.jqID(w.themodal), {gb: "#gbox_" + a.jgrid.jqID(s), jqm: d.jqModal, onClose: b[o.p.id].onClose})) : b[o.p.id].clearAfterAdd && g("_empty", o, t)) : (b[o.p.id].reloadAfterSubmit ? (a(o).trigger("reloadGrid"), b[o.p.id].closeAfterEdit || setTimeout(function () {
                            a(o).jqGrid("setSelection", p[e])
                        }, 1e3)) : o.p.treeGrid === !0 ? a(o).jqGrid("setTreeRow", p[e], p) : a(o).jqGrid("setRowData", p[e], p), b[o.p.id].closeAfterEdit && a.jgrid.hideModal("#" + a.jgrid.jqID(w.themodal), {gb: "#gbox_" + a.jgrid.jqID(s), jqm: d.jqModal, onClose: b[o.p.id].onClose})), a.isFunction(b[o.p.id].afterComplete) && (c = h, setTimeout(function () {
            ...
            var o = this;
            if (o.grid && c) {
                var p, q, r, s = o.p.id, t = "FrmGrid_" + s, u = "TblGrid_" + s, v = "#" + a.jgrid.jqID(u), w = {themodal: "editmod" + s, modalhead: "edithd" + s, modalcontent: "editcnt" + s, scrollelm: t}, x = a.isFunction(b[o.p.id].beforeShowForm) ? b[o.p.id].beforeShowForm : !1, y = a.isFunction(b[o.p.id].afterShowForm) ? b[o.p.id].afterShowForm : !1, z = a.isFunction(b[o.p.id].beforeInitData) ? b[o.p.id].beforeInitData : !1, A = a.isFunction(b[o.p.id].onInitializeForm) ? b[o.p.id].onInitializeForm : !1, B = !0, C = 1, D = 0, t = a.jgrid.jqID(t);
                ...
                if (d.checkOnUpdate && d.jqModal && !d.modal && (E = !1), void 0 !== a("#" + a.jgrid.jqID(w.themodal))[0]) {
                    ...
                    !0 === d.closeOnEscape && (d.closeOnEscape = !1, L = !0), u = a("<div></div>").append(F).append(u), a.jgrid.createModal(w, u, d, "#gview_" + a.jgrid.jqID(o.p.id), a("#gbox_" + a.jgrid.jqID(o.p.id))[0]), z && (a("#pData, #nData", v + "_2").css("float", "right"), a(".EditButton", v + "_2").css("text-align", "left")), b[o.p.id].topinfo && a(".tinfo", v).show(), b[o.p.id].bottominfo && a(".binfo", v + "_2").show(), u = u = null, a("#" + a.jgrid.jqID(w.themodal)).keydown(function (c) {
                        ...
                        if (27 === c.which)return k() ? (L && a.jgrid.hideModal("#" + a.jgrid.jqID(w.themodal), {gb: d.gbox, jqm: d.jqModal, onClose: b[o.p.id].onClose}), !1) : !1;
        ...
        return d = a.extend(!0, {top: 0, left: 0, width: 0, datawidth: "auto", height: "auto", dataheight: "auto", modal: !1, overlay: 30, drag: !0, resize: !0, jqModal: !0, closeOnEscape: !1, labelswidth: "30%", closeicon: [], navkeys: [!1, 38, 40], onClose: null, beforeShowForm: null, beforeInitData: null, viewPagerButtons: !0, recreateForm: !1}, a.jgrid.view, d || {}), b[a(this)[0].p.id] = d, this.each(function () {
            function e() {
            ...
            function f(b, c, e, f) {
                ...
                return a(c.p.colModel).each(function () {
                    ...
                    if (g = this.name, n = !1, k = (h = this.editrules && !0 === this.editrules.edithidden ? !1 : !0 === this.hidden ? !0 : !1) ? "style='display:none'" : "", o = "boolean" != typeof this.viewable ? !0 : this.viewable, "cb" !== g && "subgrid" !== g && "rn" !== g && o) {
                        ...
                        var d = a.extend({}, {rowabove: !1, rowcontent: ""}, this.formoptions || {}), l = parseInt(d.rowpos, 10) || p + 1, s = parseInt(2 * (parseInt(d.colpos, 10) || 1), 10);
                        if (d.rowabove) {
                            var u = a("<tr><td class='contentinfo' colspan='" + 2 * f + "'>" + d.rowcontent + "</td></tr>");
                            a(e).append(u), u[0].rp = l
                        }
                        i = a(e).find("tr[rowpos=" + l + "]"), 0 === i.length && (i = a("<tr " + k + " rowpos='" + l + "'></tr>").addClass("FormData").attr("id", "trv_" + g), a(i).append(t), a(e).append(i), i[0].rp = l), a("td:eq(" + (s - 2) + ")", i[0]).html("<b>" + (void 0 === d.label ? c.p.colNames[b] : d.label) + "</b>"), a("td:eq(" + (s - 1) + ")", i[0]).append("<span>" + j + "</span>").attr("id", "v_" + g), n && a("td:eq(" + (s - 1) + ") span", i[0]).css({"text-align": "right", width: m + "px"}), q[p] = b, p++
                    }
            ...
            var j = this;
            if (j.grid && c) {
                var k = j.p.id, l = "ViewGrid_" + a.jgrid.jqID(k), m = "ViewTbl_" + a.jgrid.jqID(k), n = "ViewGrid_" + k, o = "ViewTbl_" + k, p = {themodal: "viewmod" + k, modalhead: "viewhd" + k, modalcontent: "viewcnt" + k, scrollelm: l}, q = a.isFunction(b[j.p.id].beforeInitData) ? b[j.p.id].beforeInitData : !1, r = !0, s = 1, t = 0;
                if (!0 === d.recreateForm && void 0 !== a("#" + a.jgrid.jqID(p.themodal))[0] && a("#" + a.jgrid.jqID(p.themodal)).remove(), void 0 !== a("#" + a.jgrid.jqID(p.themodal))[0]) {
                    ...
                    a(".ui-jqdialog-title", "#" + a.jgrid.jqID(p.modalhead)).html(d.caption), a("#FormError", "#" + m).hide(), g(c, j), a.isFunction(b[j.p.id].beforeShowForm) && b[j.p.id].beforeShowForm.call(j, a("#" + l)), a.jgrid.viewModal("#" + a.jgrid.jqID(p.themodal), {gbox: "#gbox_" + a.jgrid.jqID(k), jqm: d.jqModal, jqM: !1, overlay: d.overlay, modal: d.modal}), e()
                } else {
        ...
        return d = a.extend(!0, {top: 0, left: 0, width: 240, height: "auto", dataheight: "auto", modal: !1, overlay: 30, drag: !0, resize: !0, url: "", mtype: "POST", reloadAfterSubmit: !0, beforeShowForm: null, beforeInitData: null, afterShowForm: null, beforeSubmit: null, onclickSubmit: null, afterSubmit: null, jqModal: !0, closeOnEscape: !1, delData: {}, delicon: [], cancelicon: [], onClose: null, ajaxDelOptions: {}, processing: !1, serializeDelData: null, useDataProxy: !1}, a.jgrid.del, d || {}), b[a(this)[0].p.id] = d, this.each(function () {
            var e = this;
            if (e.grid && c) {
                var f, g, h, i, j = a.isFunction(b[e.p.id].beforeShowForm), k = a.isFunction(b[e.p.id].afterShowForm), l = a.isFunction(b[e.p.id].beforeInitData) ? b[e.p.id].beforeInitData : !1, m = e.p.id, n = {}, o = !0, p = "DelTbl_" + a.jgrid.jqID(m), q = "DelTbl_" + m, r = {themodal: "delmod" + m, modalhead: "delhd" + m, modalcontent: "delcnt" + m, scrollelm: p};
                if (a.isArray(c) && (c = c.join()), void 0 !== a("#" + a.jgrid.jqID(r.themodal))[0]) {
                    if (l && (o = l.call(e, a("#" + p)), void 0 === o && (o = !0)), !1 === o)return;
                    a("#DelData>td", "#" + p).text(c), a("#DelError", "#" + p).hide(), !0 === b[e.p.id].processing && (b[e.p.id].processing = !1, a("#dData", "#" + p).removeClass("ui-state-active")), j && b[e.p.id].beforeShowForm.call(e, a("#" + p)), a.jgrid.viewModal("#" + a.jgrid.jqID(r.themodal), {gbox: "#gbox_" + a.jgrid.jqID(m), jqm: b[e.p.id].jqModal, jqM: !1, overlay: b[e.p.id].overlay, modal: b[e.p.id].modal})
                } else {
                    ...
                    a(".fm-button", "#" + p + "_2").hover(function () {
                        ...
                        if (n = {}, a.isFunction(b[e.p.id].onclickSubmit) && (n = b[e.p.id].onclickSubmit.call(e, b[e.p.id], k) || {}), a.isFunction(b[e.p.id].beforeSubmit) && (j = b[e.p.id].beforeSubmit.call(e, k)), j[0] && !b[e.p.id].processing) {
                            ...
                            f[g] = k.join(), a(this).addClass("ui-state-active"), c = a.extend({url: b[e.p.id].url || a(e).jqGrid("getGridParam", "editurl"), type: b[e.p.id].mtype, data: a.isFunction(b[e.p.id].serializeDelData) ? b[e.p.id].serializeDelData.call(e, f) : f, complete: function (c, g) {
                                var h;
                                ...
                                b[e.p.id].processing = !1, a("#dData", "#" + p + "_2").removeClass("ui-state-active"), j[0] && a.jgrid.hideModal("#" + a.jgrid.jqID(r.themodal), {gb: "#gbox_" + a.jgrid.jqID(m), jqm: d.jqModal, onClose: b[e.p.id].onClose})
                            }}, a.jgrid.ajaxOptions, b[e.p.id].ajaxDelOptions), c.url || b[e.p.id].useDataProxy || (a.isFunction(e.p.dataProxy) ? b[e.p.id].useDataProxy = !0 : (j[0] = !1, j[1] = j[1] + (" " + a.jgrid.errors.nourl))), j[0] && (b[e.p.id].useDataProxy ? (c = e.p.dataProxy.call(e, c, "del_" + e.p.id), void 0 === c && (c = [!0, ""]), c[0] === !1 ? (j[0] = !1, j[1] = c[1] || "Error deleting the selected row!") : a.jgrid.hideModal("#" + a.jgrid.jqID(r.themodal), {gb: "#gbox_" + a.jgrid.jqID(m), jqm: d.jqModal, onClose: b[e.p.id].onClose})) : a.ajax(c))
                        }
                        return j[0] === !1 && (a("#DelError>td", "#" + p).html(j[1]), a("#DelError", "#" + p).show()), !1
                    }), a("#eData", "#" + p + "_2").click(function () {
                        return a.jgrid.hideModal("#" + a.jgrid.jqID(r.themodal), {gb: "#gbox_" + a.jgrid.jqID(m), jqm: b[e.p.id].jqModal, onClose: b[e.p.id].onClose}), !1
                    }), j && b[e.p.id].beforeShowForm.call(e, a("#" + p)), a.jgrid.viewModal("#" + a.jgrid.jqID(r.themodal), {gbox: "#gbox_" + a.jgrid.jqID(m), jqm: b[e.p.id].jqModal, overlay: b[e.p.id].overlay, modal: b[e.p.id].modal})
                }
        ...
        return c = a.extend({edit: !0, editicon: "ui-icon-pencil", add: !0, addicon: "ui-icon-plus", del: !0, delicon: "ui-icon-trash", search: !0, searchicon: "ui-icon-search", refresh: !0, refreshicon: "ui-icon-refresh", refreshstate: "firstpage", view: !1, viewicon: "ui-icon-document", position: "left", closeOnEscape: !0, beforeRefresh: null, afterRefresh: null, cloneToTop: !1, alertwidth: 200, alertheight: "auto", alerttop: null, alertleft: null, alertzIndex: null}, a.jgrid.nav, c || {}), this.each(function () {
            if (!this.nav) {
                var i, j = {themodal: "alertmod_" + this.p.id, modalhead: "alerthd_" + this.p.id, modalcontent: "alertcnt_" + this.p.id}, k = this;
                if (k.grid && "string" == typeof b) {
                    void 0 === a("#" + j.themodal)[0] && (!c.alerttop && !c.alertleft && (void 0 !== window.innerWidth ? (c.alertleft = window.innerWidth, c.alerttop = window.innerHeight) : void 0 !== document.documentElement && void 0 !== document.documentElement.clientWidth && 0 !== document.documentElement.clientWidth ? (c.alertleft = document.documentElement.clientWidth, c.alerttop = document.documentElement.clientHeight) : (c.alertleft = 1024, c.alerttop = 768), c.alertleft = c.alertleft / 2 - parseInt(c.alertwidth, 10) / 2, c.alerttop = c.alerttop / 2 - 25), a.jgrid.createModal(j, "<div>" + c.alerttext + "</div><span tabindex='0'><span tabindex='-1' id='jqg_alrt'></span></span>", {gbox: "#gbox_" + a.jgrid.jqID(k.p.id), jqModal: !0, drag: !0, resize: !0, caption: c.alertcap, top: c.alerttop, left: c.alertleft, width: c.alertwidth, height: c.alertheight, closeOnEscape: c.closeOnEscape, zIndex: c.alertzIndex}, "#gview_" + a.jgrid.jqID(k.p.id), a("#gbox_" + a.jgrid.jqID(k.p.id))[0], !0));
                    ...
                    for (c.cloneToTop && k.p.toppager && (m = 2), l = 0; m > l; l++) {
                        ...
                        0 === l ? (p = b, q = k.p.id, p === k.p.toppager && (q += "_top", m = 1)) : (p = k.p.toppager, q = k.p.id + "_top"), "rtl" === k.p.direction && a(r).attr("dir", "rtl").css("float", "right"), c.add && (e = e || {}, i = a("<td class='ui-pg-button ui-corner-all'></td>"), a(i).append("<div class='ui-pg-div'><span class='ui-icon " + c.addicon + "'></span>" + c.addtext + "</div>"), a("tr", r).append(i), a(i, r).attr({title: c.addtitle || "", id: e.id || "add_" + q}).click(function () {
                            return a(this).hasClass("ui-state-disabled") || (a.isFunction(c.addfunc) ? c.addfunc.call(k) : a(k).jqGrid("editGridRow", "new", e)), !1
                        }).hover(n, o), i = null), c.edit && (i = a("<td class='ui-pg-button ui-corner-all'></td>"), d = d || {}, a(i).append("<div class='ui-pg-div'><span class='ui-icon " + c.editicon + "'></span>" + c.edittext + "</div>"), a("tr", r).append(i), a(i, r).attr({title: c.edittitle || "", id: d.id || "edit_" + q}).click(function () {
                            if (!a(this).hasClass("ui-state-disabled")) {
                                var b = k.p.selrow;
                                b ? a.isFunction(c.editfunc) ? c.editfunc.call(k, b) : a(k).jqGrid("editGridRow", b, d) : (a.jgrid.viewModal("#" + j.themodal, {gbox: "#gbox_" + a.jgrid.jqID(k.p.id), jqm: !0}), a("#jqg_alrt").focus())
                            }
                            return!1
                        }).hover(n, o), i = null), c.view && (i = a("<td class='ui-pg-button ui-corner-all'></td>"), h = h || {}, a(i).append("<div class='ui-pg-div'><span class='ui-icon " + c.viewicon + "'></span>" + c.viewtext + "</div>"), a("tr", r).append(i), a(i, r).attr({title: c.viewtitle || "", id: h.id || "view_" + q}).click(function () {
                            if (!a(this).hasClass("ui-state-disabled")) {
                                var b = k.p.selrow;
                                b ? a.isFunction(c.viewfunc) ? c.viewfunc.call(k, b) : a(k).jqGrid("viewGridRow", b, h) : (a.jgrid.viewModal("#" + j.themodal, {gbox: "#gbox_" + a.jgrid.jqID(k.p.id), jqm: !0}), a("#jqg_alrt").focus())
                            }
                            return!1
                        }).hover(n, o), i = null), c.del && (i = a("<td class='ui-pg-button ui-corner-all'></td>"), f = f || {}, a(i).append("<div class='ui-pg-div'><span class='ui-icon " + c.delicon + "'></span>" + c.deltext + "</div>"), a("tr", r).append(i), a(i, r).attr({title: c.deltitle || "", id: f.id || "del_" + q}).click(function () {
                            if (!a(this).hasClass("ui-state-disabled")) {
                                var b;
                                k.p.multiselect ? (b = k.p.selarrrow, 0 === b.length && (b = null)) : b = k.p.selrow, b ? a.isFunction(c.delfunc) ? c.delfunc.call(k, b) : a(k).jqGrid("delGridRow", b, f) : (a.jgrid.viewModal("#" + j.themodal, {gbox: "#gbox_" + a.jgrid.jqID(k.p.id), jqm: !0}), a("#jqg_alrt").focus())
                            }
                            return!1
                        }).hover(n, o), i = null), (c.add || c.edit || c.del || c.view) && a("tr", r).append("<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>"), c.search && (i = a("<td class='ui-pg-button ui-corner-all'></td>"), g = g || {}, a(i).append("<div class='ui-pg-div'><span class='ui-icon " + c.searchicon + "'></span>" + c.searchtext + "</div>"), a("tr", r).append(i), a(i, r).attr({title: c.searchtitle || "", id: g.id || "search_" + q}).click(function () {
                            return a(this).hasClass("ui-state-disabled") || (a.isFunction(c.searchfunc) ? c.searchfunc.call(k, g) : a(k).jqGrid("searchGrid", g)), !1
                        }).hover(n, o), g.showOnLoad && !0 === g.showOnLoad && a(i, r).click(), i = null), c.refresh && (i = a("<td class='ui-pg-button ui-corner-all'></td>"), a(i).append("<div class='ui-pg-div'><span class='ui-icon " + c.refreshicon + "'></span>" + c.refreshtext + "</div>"), a("tr", r).append(i), a(i, r).attr({title: c.refreshtitle || "", id: "refresh_" + q}).click(function () {
                            if (!a(this).hasClass("ui-state-disabled")) {
        ...
        return c = a.extend({caption: "newButton", title: "", buttonicon: "ui-icon-newwin", onClickButton: null, position: "last", cursor: "pointer"}, c || {}), this.each(function () {
            if (this.grid) {
    ...
    a.fn.jqFilter = function (b) {
        ...
        var e = a.extend(!0, {filter: null, columns: [], onChange: null, afterRedraw: null, checkValues: null, error: !1, errmsg: "", errorcheck: !0, showQuery: !0, sopt: null, ops: [], operands: null, numopts: "eq,ne,lt,le,gt,ge,nu,nn,in,ni".split(","), stropts: "eq,ne,bw,bn,ew,en,cn,nc,nu,nn,in,ni".split(","), strarr: ["text", "string", "blob"], groupOps: [
            {op: "AND", text: "AND"},
            {op: "OR", text: "OR"}
        ], groupButton: !0, ruleButtons: !0, direction: "ltr"}, a.jgrid.filter, b || {});
        return this.each(function () {
            if (!this.filter) {
                this.p = e, (null === this.p.filter || void 0 === this.p.filter) && (this.p.filter = {groupOp: this.p.groupOps[0].op, rules: [], groups: []});
                ...
                if (this.p.initFilter = a.extend(!0, {}, this.p.filter), d) {
                    ...
                    this.onchange = function () {
                        ...
                        if (i = "<span></span>", this.p.groupButton && (i = a("<input type='button' value='+ {}' title='Add subgroup' class='add-group'/>"), i.bind("click", function () {
                            return void 0 === b.groups && (b.groups = []), b.groups.push({groupOp: e.groupOps[0].op, rules: [], groups: []}), f.reDraw(), f.onchange(), !1
                            ...
                            i.bind("click", function () {
                                ...
                                return c = l.searchoptions.sopt ? l.searchoptions.sopt : f.p.sopt ? f.p.sopt : -1 !== a.inArray(l.searchtype, f.p.strarr) ? f.p.stropts : f.p.numopts, b.rules.push({field: l.name, op: c[0], data: ""}), f.reDraw(), !1
                            }), h.append(i)
                        }
    ...
    a.jgrid.inlineEdit = a.jgrid.inlineEdit || {}, a.jgrid.extend({editRow: function (b, c, d, e, f, g, h, i, j) {
        ...
        var k, l, m, n, j = a.extend(!0, {successfunc: null, url: null, extraparam: {}, aftersavefunc: null, errorfunc: null, afterrestorefunc: null, restoreAfterError: !0, mtype: "POST"}, a.jgrid.inlineEdit, j), o = !1, p = this[0], q = {}, r = {}, s = {};
        if (!p.grid)return o;
            ...
            if (i = a(n).attr("editable"), j.url = j.url || p.p.editurl, "1" === i) {
                ...
                if (a('td[role="gridcell"]', n).each(function (b) {
                    ...
                    try {
                        ...
                        a.jgrid.info_dialog(a.jgrid.errors.errcap, m[1], a.jgrid.edit.bClose, {left: v[0], top: v[1] + a(u).outerHeight()})
                    } catch (w) {
                        alert(m[1])
                    }
                    return o
                ...
                } else a("#lui_" + a.jgrid.jqID(p.p.id)).show(), s = a.extend({}, q, s), s[v] = a.jgrid.stripPref(p.p.idPrefix, s[v]), a.ajax(a.extend({url: j.url, data: a.isFunction(p.p.serializeRowData) ? p.p.serializeRowData.call(p, s) : s, type: j.mtype, async: !1, complete: function (c, d) {
        ...
        return c = a.extend(!0, {edit: !0, editicon: "ui-icon-pencil", add: !0, addicon: "ui-icon-plus", save: !0, saveicon: "ui-icon-disk", cancel: !0, cancelicon: "ui-icon-cancel", addParams: {addRowParams: {extraparam: {}}}, editParams: {}, restoreAfterSelect: !0}, a.jgrid.nav, c || {}), this.each(function () {
            if (this.grid) {
                ...
                c.add && a(e).jqGrid("navButtonAdd", b, {caption: c.addtext, title: c.addtitle, buttonicon: c.addicon, id: e.p.id + "_iladd", onClickButton: function () {
                    ...
                    b ? (a(e).jqGrid("editRow", b, c.editParams), a("#" + f + "_ilsave").removeClass("ui-state-disabled"), a("#" + f + "_ilcancel").removeClass("ui-state-disabled"), a("#" + f + "_iladd").addClass("ui-state-disabled"), a("#" + f + "_iledit").addClass("ui-state-disabled")) : (a.jgrid.viewModal("#alertmod", {gbox: "#gbox_" + f, jqm: !0}), a("#jqg_alrt").focus())
                ...
                }}), a("#" + f + "_ilsave").addClass("ui-state-disabled")), c.cancel && (a(e).jqGrid("navButtonAdd", b, {caption: c.canceltext || "", title: c.canceltitle || "Cancel row editing", buttonicon: c.cancelicon, id: e.p.id + "_ilcancel", onClickButton: function () {
                    var b = e.p.savedRow[0].id, d = {};
                    b ? (d = a("#" + a.jgrid.jqID(b), "#" + f).hasClass("jqgrid-new-row") ? c.addParams.addRowParams : c.editParams, a(e).jqGrid("restoreRow", b, d), a(e).jqGrid("showAddEditButtons")) : (a.jgrid.viewModal("#alertmod", {gbox: "#gbox_" + f, jqm: !0}), a("#jqg_alrt").focus())
            ...
            if (i.grid && !0 === i.p.cellEdit) {
                ...
                if (h = i.p.colModel[c], e = h.name, "subgrid" !== e && "cb" !== e && "rn" !== e) {
                    if (g = a("td:eq(" + c + ")", i.rows[b]), !0 !== h.editable || !0 !== d || g.hasClass("not-editable-cell"))0 <= parseInt(i.p.iCol, 10) && 0 <= parseInt(i.p.iRow, 10) && (a("td:eq(" + i.p.iCol + ")", i.rows[i.p.iRow]).removeClass("edit-cell ui-state-highlight"), a(i.rows[i.p.iRow]).removeClass("selected-row ui-state-hover")), g.addClass("edit-cell ui-state-highlight"), a(i.rows[b]).addClass("selected-row ui-state-hover"), f = g.html().replace(/\&#160\;/gi, ""), a(i).triggerHandler("jqGridSelectCell", [i.rows[b].id, e, f, b, c]), a.isFunction(i.p.onSelectCell) && i.p.onSelectCell.call(i, i.rows[b].id, e, f, b, c); else {
                        ...
                        var k = a.extend({}, h.editoptions || {}, {id: b + "_" + e, name: e}), l = a.jgrid.createEl.call(i, h.edittype, k, f, !0, a.extend({}, a.jgrid.ajaxOptions, i.p.ajaxSelectOptions || {}));
                    ...
                    if (g !== e.p.savedRow[d].v) {
                        ...
                        if (!0 === o[0]) {
                            if (d = a(e).triggerHandler("jqGridBeforeSubmitCell", [e.rows[b].id, j, f, b, c]) || {}, a.isFunction(e.p.beforeSubmitCell) && ((d = e.p.beforeSubmitCell.call(e, e.rows[b].id, j, f, b, c)) || (d = {})), 0 < a("input.hasDatepicker", h).length && a("input.hasDatepicker", h).datepicker("hide"), "remote" === e.p.cellsubmit)if (e.p.cellurl) {
                                var p = {};
                                e.p.autoencode && (f = a.jgrid.htmlEncode(f)), p[j] = f, m = e.p.prmNames, i = m.id, k = m.oper, p[i] = a.jgrid.stripPref(e.p.idPrefix, e.rows[b].id), p[k] = m.editoper, p = a.extend(d, p), a("#lui_" + a.jgrid.jqID(e.p.id)).show(), e.grid.hDiv.loading = !0, a.ajax(a.extend({url: e.p.cellurl, data: a.isFunction(e.p.serializeCellData) ? e.p.serializeCellData.call(e, p) : p, type: "POST", complete: function (d, i) {
    ...
    a.fn.jqm = function (d) {
        var f = {overlay: 50, closeoverlay: !0, overlayClass: "jqmOverlay", closeClass: "jqmClose", trigger: ".jqModal", ajax: e, ajaxText: "", target: e, modal: e, toTop: e, onShow: e, onHide: e, onLoad: e};
        return this.each(function () {
    ...
    }, a.jqm = {hash: {}, open: function (b, h) {
        var i = c[b], j = i.c, k = "." + j.closeClass, l = parseInt(i.w.css("z-index")), l = l > 0 ? l : 3e3, m = a("<div></div>").css({height: "100%", width: "100%", position: "fixed", left: 0, top: 0, "z-index": l - 1, opacity: j.overlay / 100});
        ...
        return b.each(function () {
            ...
            a(d).each(function () {
                this[f] || (this[f] = [], a(this).click(function () {
                    for (var a in{jqmShow: 1, jqmHide: 1})for (var b in this[a])c[this[a][b]] && c[this[a][b]].w[a](this);
                    return e
                })), this[f].push(b)
            })
        })
    ...
    var b, c, d = a.jqDnR, e = d.dnr, f = d.e, g = function (d, g, j, k) {
        return d.each(function () {
            g = g ? a(g, d) : d, g.bind("mousedown", {e: d, k: j}, function (d) {
                ...
                if (e = {X: j.left || h("left") || 0, Y: j.top || h("top") || 0, W: h("width") || f[0].scrollWidth || 0, H: h("height") || f[0].scrollHeight || 0, pX: d.pageX, pY: d.pageY, k: g.k}, c = b && "d" != g.k ? {X: j.left || i("left") || 0, Y: j.top || i("top") || 0, W: b[0].offsetWidth || i("width") || 0, H: b[0].offsetHeight || i("height") || 0, pX: d.pageX, pY: d.pageY, k: g.k} : !1, a("input.hasDatepicker", f[0])[0])try {
            ...
            if (d.grid) {
                var e, f, g, h, i, j = function (b, c, e) {
                    ...
                    if (!d.grid.hDiv.loading)switch (d.grid.hDiv.loading = !0, a("#load_" + a.jgrid.jqID(d.p.id)).show(), d.p.subgridtype || (d.p.subgridtype = d.p.datatype), a.isFunction(d.p.subgridtype) ? d.p.subgridtype.call(d, e) : d.p.subgridtype = d.p.subgridtype.toLowerCase(), d.p.subgridtype) {
                        case"xml":
                        case"json":
                            a.ajax(a.extend({type: d.p.mtype, url: d.p.subGridUrl, dataType: d.p.subgridtype, data: a.isFunction(d.p.serializeSubGridData) ? d.p.serializeSubGridData.call(d, e) : e, complete: function (b) {
    ...
    a.extend(a.jgrid, {template: function (b) {
        ...
        return this.each(function () {
            ...
            if (e.p.treeGrid) {
                ...
                a.each(e.p.treeReader, function (b, c) {
                    c && -1 === a.inArray(c, h) && ("leaf_field" === b && (e.p._treeleafpos = f), f++, e.p.colNames.push(c), e.p.colModel.push({name: c, width: 1, hidden: !0, sortable: !1, resizable: !1, hidedlg: !0, editable: !0, search: !1}))
                })
            }
        })
        ...
        return this.each(function () {
            if (this.grid && this.p.treeGrid) {
                ...
                if (!b[c]) {
                    ...
                    a(this).jqGrid("isNodeLoaded", this.p.data[k]) ? (b[c] = !0, a("div.treeclick", j).removeClass(this.p.treeIcons.plus + " tree-plus").addClass(this.p.treeIcons.minus + " tree-minus")) : this.grid.hDiv.loading || (b[c] = !0, a("div.treeclick", j).removeClass(this.p.treeIcons.plus + " tree-plus").addClass(this.p.treeIcons.minus + " tree-minus"), this.p.treeANode = j.rowIndex, this.p.datatype = this.p.treedatatype, "nested" === this.p.treeGridModel ? a(this).jqGrid("setGridParam", {postData: {nodeid: i, n_left: b[g], n_right: b[h], n_level: b[f]}}) : a(this).jqGrid("setGridParam", {postData: {nodeid: i, parentid: b[d], n_level: b[f]}}), a(this).trigger("reloadGrid"), b[e] = !0, "nested" === this.p.treeGridModel ? a(this).jqGrid("setGridParam", {postData: {nodeid: "", n_left: "", n_right: "", n_level: ""}}) : a(this).jqGrid("setGridParam", {postData: {nodeid: "", parentid: "", n_level: ""}}))
                }
            }
        })
    ...
    a.jgrid.extend({jqGridImport: function (b) {
        return b = a.extend({imptype: "xml", impstring: "", impurl: "", mtype: "GET", impData: {}, xmlGrid: {config: "roots>grid", data: "roots>rows"}, jsonGrid: {config: "grid", data: "data"}, ajaxOptions: {}}, b || {}), this.each(function () {
            ...
            switch (b.imptype) {
                case"xml":
                    a.ajax(a.extend({url: b.impurl, type: b.mtype, data: b.impData, dataType: "xml", complete: function (e, f) {
                ...
                case"xmlstring":
                    ...
                    break;
                case"json":
                    a.ajax(a.extend({url: b.impurl, type: b.mtype, data: b.impData, dataType: "json", complete: function (d) {
                        try {
        ...
        return b = a.extend({exptype: "remote", url: null, oper: "oper", tag: "excel", exportOptions: {}}, b || {}), this.each(function () {
            if (this.grid) {
                var c;
...
!function (b) {
    ...
    b.jgrid.extend({sortableColumns: function (a) {
        return this.each(function () {
            ...
            var d = this, e = b.jgrid.jqID(d.p.id), e = {tolerance: "pointer", axis: "x", scrollSensitivity: "1", items: ">th:not(:has(#jqgh_" + e + "_cb,#jqgh_" + e + "_rn,#jqgh_" + e + "_subgrid),:hidden)", placeholder: {element: function (a) {
        ...
        if (!b("#colchooser_" + b.jgrid.jqID(d[0].p.id)).length) {
            var e = b('<div id="colchooser_' + d[0].p.id + '" style="position:relative;overflow:hidden"><div><select multiple="multiple"></select></div></div>'), f = b("select", e), a = b.extend({width: 420, height: 240, classname: null, done: function (a) {
                ...
                return c[a.bSubmit] = function () {
                    ...
                    a.cleanup(!0)
                }, b.extend(!0, {buttons: c, close: function () {
                    a.cleanup(!0)
            ...
            a.caption && e.attr("title", a.caption), a.classname && (e.addClass(a.classname), f.addClass(a.classname)), a.width && (b(">div", e).css({width: a.width, margin: "0 auto"}), f.css("width", a.width)), a.height && (b(">div", e).css("height", a.height), f.css("height", a.height - 10));
        ...
        return this.each(function () {
            var c = this;
            c.grid && !c.p.treeGrid && b.fn.sortable && (a = b.extend({cursor: "move", axis: "y", items: ".jqgrow"}, a || {}), a.start && b.isFunction(a.start) ? (a._start_ = a.start, delete a.start) : a._start_ = !1, a.update && b.isFunction(a.update) ? (a._update_ = a.update, delete a.update) : a._update_ = !1, a.start = function (d, e) {
        ...
        return this.each(function () {
            ...
            var d, e, f = this;
            if (f.grid && !f.p.treeGrid && b.fn.draggable && b.fn.droppable)if (void 0 === b("#jqgrid_dnd")[0] && b("body").append("<table id='jqgrid_dnd' class='ui-jqgrid-dnd'></table>"), "string" == typeof a && "updateDnD" === a && f.p.jqgdnd === !0)c(); else if (a = b.extend({drag: function (a) {
                return b.extend({start: function (c, d) {
                    var e;
                    if (f.p.subGrid) {
            ...
            }, onstart: null, onstop: null, beforedrop: null, ondrop: null, drop_opts: {activeClass: "ui-state-active", hoverClass: "ui-state-hover"}, drag_opts: {revert: "invalid", helper: "clone", cursor: "move", appendTo: "#jqgrid_dnd", zIndex: 5e3}, dragcopy: !1, dropbyname: !1, droppos: "first", autoid: !0, autoidprefix: "dnd_"}, a || {}), a.connectWith)for (a.connectWith = a.connectWith.split(","), a.connectWith = b.map(a.connectWith, function (a) {
                return b.trim(a)
