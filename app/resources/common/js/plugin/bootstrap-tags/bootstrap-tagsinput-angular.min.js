...
angular.module("bootstrap-tagsinput", []).directive("bootstrapTagsinput", [function () {
    ...
    return{restrict: "EA", scope: {model: "=ngModel"}, template: "<select multiple></select>", replace: !1, link: function (b, c, d) {
        $(function () {
            angular.isArray(b.model) || (b.model = []);
            var e = $("select", c);
            e.tagsinput({typeahead: {source: angular.isFunction(b.$parent[d.typeaheadSource]) ? b.$parent[d.typeaheadSource] : null}, itemValue: a(b, d.itemvalue), itemText: a(b, d.itemtext), tagClass: angular.isFunction(b.$parent[d.tagclass]) ? b.$parent[d.tagclass] : function () {
                return d.tagclass
            }});
