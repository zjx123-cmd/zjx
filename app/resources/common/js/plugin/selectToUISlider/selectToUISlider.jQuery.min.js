...
jQuery.fn.selectToUISlider = function (a) {
    ...
    var e = jQuery(this), f = jQuery.extend({labels: 3, tooltip: !0, tooltipSrc: "text", labelSrc: "value", sliderOptions: null}, a), g = function () {
        var a = [];
        ...
        return e.eq(0).find("option").each(function () {
            a.push({value: jQuery(this).attr("value"), text: jQuery(this).text()})
        }), a
    }(), i = function () {
        if (e.eq(0).find("optgroup").size() > 0) {
            ...
            return e.eq(0).find("optgroup").each(function (b) {
                a[b] = {}, a[b].label = jQuery(this).attr("label"), a[b].options = [], jQuery(this).find("option").each(function () {
                    a[b].options.push({text: jQuery(this).text(), value: jQuery(this).attr("value")})
                })
            }), a
        }
        return null
    }(), j = {step: 1, min: 0, orientation: "horizontal", max: h.length - 1, range: e.length > 1, slide: function (a, b) {
        var d = jQuery(b.handle), e = c(b.value);
    ...
    f.sliderOptions = a ? jQuery.extend(j, a.sliderOptions) : j, e.bind("change keyup click", function () {
        var a = jQuery(this).get(0).selectedIndex, b = jQuery("#handle_" + jQuery(this).attr("id")), c = b.data("handleNum");
        b.parents(".ui-slider:eq(0)").slider("values", c, a)
    });
    var k = jQuery("<div></div>");
    if (e.each(function (a) {
        var b = "", d = jQuery("label[for=" + jQuery(this).attr("id") + "]"), e = d.size() > 0 ? "Slider control for " + d.text() : "", h = d.attr("id") || d.attr("id", "label_" + g[a]).attr("id");
        ...
        var l = 0, m = k.append('<dl class="ui-slider-scale ui-helper-reset" role="presentation"></dl>').find(".ui-slider-scale:eq(0)");
        jQuery(i).each(function (a) {
            ...
            jQuery(this.options).each(function (a) {
                var c = l == h.length - 1 || 0 == l ? 'style="display: none;"' : "", e = "text" == f.labelSrc ? b[a].text : b[a].value;
        ...
        jQuery(h).each(function (a) {
            var b = a == h.length - 1 || 0 == a ? 'style="display: none;"' : "", c = "text" == f.labelSrc ? this.text : this.value;
    ...
    k.find(".ui-slider-scale dt").each(function (a) {
        ...
        var a = jQuery(".ui-tooltip-pointer-down-inner").css("borderTopWidth"), b = jQuery(this).parents(".ui-slider-tooltip").css("backgroundColor");
