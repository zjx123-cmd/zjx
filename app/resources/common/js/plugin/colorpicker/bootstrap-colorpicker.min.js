...
!function (a) {
    ...
    b.prototype = {constructor: b, setColor: function (b) {
        ...
        return g /= f > 0 && 1 >= f ? f : 2 - f, f /= 2, g > 1 && (g = 1), {h: e, s: g, l: f, a: d || this.value.a}
    }};
    var c = function (b, c) {
        this.element = a(b);
    ...
    c.prototype = {constructor: c, show: function (b) {
        ...
        this.color = new b(this.isInput ? this.element.prop("value") : this.element.data("color")), this.picker.find("i").eq(0).css({left: 100 * this.color.value.s, top: 100 - 100 * this.color.value.b}).end().eq(1).css("top", 100 * (1 - this.color.value.h)).end().eq(2).css("top", 100 * (1 - this.color.value.a)), this.previewColor()
    }, setValue: function (a) {
        this.color = new b(a), this.picker.find("i").eq(0).css({left: 100 * this.color.value.s, top: 100 - 100 * this.color.value.b}).end().eq(1).css("top", 100 * (1 - this.color.value.h)).end().eq(2).css("top", 100 * (1 - this.color.value.a)), this.previewColor(), this.element.trigger({type: "changeColor", color: this.color})
    }, hide: function () {
        ...
        if (!e.is(".colorpicker")) {
            if (e.is(".colorpicker-saturation"))this.slider = a.extend({}, d.sliders.saturation); else if (e.is(".colorpicker-hue"))this.slider = a.extend({}, d.sliders.hue); else {
        ...
        return this.slider.knob.left = b + "px", this.slider.knob.top = c + "px", this.slider.callLeft && this.color[this.slider.callLeft].call(this.color, b / 100), this.slider.callTop && this.color[this.slider.callTop].call(this.color, c / 100), this.previewColor(), this.element.trigger({type: "changeColor", color: this.color}), !1
    }, mouseup: function (b) {
        return b.stopPropagation(), b.preventDefault(), a(document).off({mousemove: this.mousemove, mouseup: this.mouseup}), !1
    }}, a.fn.colorpicker = function (b, d) {
        return this.each(function () {
            var e = a(this), f = e.data("colorpicker"), g = "object" == typeof b && b;
            f || e.data("colorpicker", f = new c(this, a.extend({}, a.fn.colorpicker.defaults, g))), "string" == typeof b && f[b](d)
        })
    ...
    var d = {translateFormats: {rgb: function () {
        ...
        var f;
        f = .5 >= c ? c * (1 + b) : c + b - c * b;
        var g = 2 * c - f, h = a + 1 / 3, i = a, j = a - 1 / 3, k = Math.round(255 * d.HueToRGB(g, f, h)), l = Math.round(255 * d.HueToRGB(g, f, i)), m = Math.round(255 * d.HueToRGB(g, f, j));
        return[k, l, m, e || 1]
    }, stringParsers: [
