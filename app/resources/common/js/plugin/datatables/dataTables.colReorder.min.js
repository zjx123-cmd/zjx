...
!function (a, b, c) {
    ...
    $.fn.dataTableExt.oApi.fnColReorder = function (a, b, c) {
        var g, h, i, j, k, l, m = $.fn.dataTable.Api ? !0 : !1, n = a.aoColumns.length;
        if (b != c) {
            ...
            if (null !== a.aaSortingFixed)for (g = 0, h = a.aaSortingFixed.length; h > g; g++)a.aaSortingFixed[g][0] = p[a.aaSortingFixed[g][0]];
            for (g = 0, h = n; h > g; g++) {
            ...
            if (a.aoColumns[b].bVisible) {
                var q = this.oApi._fnColumnIndexToVisible(a, b), r = null;
                ...
                if (null !== a.nTFoot)for (k = a.nTFoot.getElementsByTagName("tr"), g = 0, h = k.length; h > g; g++)f(k[g], q, r);
            ...
            if (null !== a.aoFooter)for (g = 0, h = a.aoFooter.length; h > g; g++)e(a.aoFooter[g], b, c);
            if (m) {
            ...
            $(a.oInstance).trigger("column-reorder", [a, {iFrom: b, iTo: c, aiInvertMapping: p}])
        }
    };
    var g = function (a) {
        "use strict";
        var f = function (b, c) {
            var d;
            return a.fn.dataTable.Api ? d = new a.fn.dataTable.Api(b).settings()[0] : b.fnSettings ? d = b.fnSettings() : "string" == typeof b ? a.fn.dataTable.fnIsDataTable(a(b)[0]) && (d = a(b).eq(0).dataTable().fnSettings()) : b.nodeName && "table" === b.nodeName.toLowerCase() ? a.fn.dataTable.fnIsDataTable(b.nodeName) && (d = a(b.nodeName).dataTable().fnSettings()) : b instanceof jQuery ? a.fn.dataTable.fnIsDataTable(b[0]) && (d = b.eq(0).dataTable().fnSettings()) : d = b, a.fn.dataTable.camelToHungarian && a.fn.dataTable.camelToHungarian(f.defaults, c || {}), this.s = {dt: null, init: a.extend(!0, {}, f.defaults, c), fixed: 0, fixedRight: 0, dropCallback: null, mouse: {startX: -1, startY: -1, offsetX: -1, offsetY: -1, target: -1, targetIndex: -1, fromIndex: -1}, aoTargets: []}, this.dom = {drag: null, pointer: null}, this.s.dt = d.oInstance.fnSettings(), this.s.dt._colReorder = this, this._fnConstruct(), d.oApi._fnCallbackReg(d, "aoDestroyCallback", a.proxy(this._fnDestroy, this), "ColReorder"), this
        };
        return f.prototype = {fnReset: function () {
            ...
            this.s.aoTargets.splice(0, this.s.aoTargets.length), this.s.aoTargets.push({x: a(this.s.dt.nTable).offset().left, to: 0});
            for (var c = 0, d = 0, e = b.length; e > d; d++)d != this.s.mouse.fromIndex && c++, b[d].bVisible && this.s.aoTargets.push({x: a(b[d].nTh).offset().left + a(b[d].nTh).outerWidth(), to: c});
        ...
        }}, f.defaults = {aiOrder: null, bRealtime: !1, iFixedColumns: 0, iFixedColumnsRight: 0, fnReorderCallback: null}, f.version = "1.1.1", a.fn.dataTable.ColReorder = f, a.fn.DataTable.ColReorder = f, "function" == typeof a.fn.dataTable && "function" == typeof a.fn.dataTableExt.fnVersionCheck && a.fn.dataTableExt.fnVersionCheck("1.9.3") ? a.fn.dataTableExt.aoFeatures.push({fnInit: function (a) {
            var b = a.oInstance;
            ...
            return null
        }, cFeature: "R", sFeature: "ColReorder"}) : alert("Warning: ColReorder requires DataTables 1.9.3 or greater - www.datatables.net/download"), a.fn.dataTable.Api && (a.fn.dataTable.Api.register("colReorder.reset()", function () {
